...
export declare class Teams {
     ...
     * @param options The optional parameters.
     */
    sendMeetingNotification(meetingId: string, notification: MeetingNotification, options?: msRest.RequestOptionsBase): Promise<Models.TeamsMeetingNotificationResponse>;
    /**
     * @param meetingId Meeting Id.
     * @param notification The content and configuration for the notification to send.
     * @param callback The callback.
     */
    sendMeetingNotification(meetingId: string, notification: MeetingNotification, callback: msRest.ServiceCallback<MeetingNotificationResponse>): void;
    /**
     * @param meetingId Meeting Id.
     * @param notification The content and configuration for the notification to send.
     * @param options The optional parameters.
     * @param callback The callback.
     */
    sendMeetingNotification(meetingId: string, notification: MeetingNotification, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<MeetingNotificationResponse>): void;
    /**
     ...
     */
    sendMessageToListOfUsers(activity: Activity, tenantId: string, members: TeamsMember[], options?: msRest.RequestOptionsBase, callback?: msRest.ServiceCallback<BatchOperationResponse>): Promise<Models.TeamsBatchOperationResponse>;
    /**
     ...
     * @returns Promise with TeamsBatchOperationResponse.
     */
    sendMessageToAllUsersInTenant(activity: Activity, tenantId: string, options?: msRest.RequestOptionsBase, callback?: msRest.ServiceCallback<BatchOperationResponse>): Promise<Models.TeamsBatchOperationResponse>;
    /**
     ...
     * @returns Promise with TeamsBatchOperationResponse.
     */
    sendMessageToAllUsersInTeam(activity: Activity, tenantId: string, teamId: string, options?: msRest.RequestOptionsBase, callback?: msRest.ServiceCallback<BatchOperationResponse>): Promise<Models.TeamsBatchOperationResponse>;
    /**
     ...
     * @returns Promise with TeamsBatchOperationResponse.
     */
    sendMessageToListOfChannels(activity: Activity, tenantId: string, members: TeamsMember[], options?: msRest.RequestOptionsBase, callback?: msRest.ServiceCallback<BatchOperationResponse>): Promise<Models.TeamsBatchOperationResponse>;
    /**
     ...
     */
    getOperationState(operationId: string, options?: msRest.RequestOptionsBase, callback?: msRest.ServiceCallback<BatchOperationStateResponse>): Promise<Models.BatchBatchOperationStateResponse>;
    /**
     ...
     */
    getOperationFailedEntries(operationId: string, options?: msRest.RequestOptionsBase, callback?: msRest.ServiceCallback<BatchFailedEntriesResponse>): Promise<Models.BatchBatchFailedEntriesResponse>;
    /**
     * Cancel an operation.
     *
     ...
     */
    cancelOperation(operationId: string, options?: msRest.RequestOptionsBase): Promise<Models.CancelOperationResponse>;
}
