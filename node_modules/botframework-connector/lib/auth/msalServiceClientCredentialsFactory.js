...
class MsalServiceClientCredentialsFactory {
    ...
    createCredentials(appId, audience, loginEndpoint, _validateAuthority) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (normalizedEndpoint === governmentConstants_1.GovernmentConstants.ToChannelFromBotLoginUrl.toLowerCase()) {
                return new msalAppCredentials_1.MsalAppCredentials(this.clientApplication, appId, governmentConstants_1.GovernmentConstants.ToChannelFromBotLoginUrl, audience || governmentConstants_1.GovernmentConstants.ToChannelFromBotOAuthScope);
            }
